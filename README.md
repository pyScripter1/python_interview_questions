...
- [Python](questions.md/#Python)
  ...
  * [GIL, потоки, процессы](questions.md/#GIL-потоки-процессы)
    ...
    + [Чем отличаются многопоточность, мультипроцессность и асинхронность](questions.md/#Чем-отличаются-многопоточность,-мультипроцессность-и-асинхронность)
...
- [Общее](questions.md/#Общее)
  ...
  * [Брокеры сообщений: подробное руководство](questions.md/#Брокеры-сообщений:-подробное-руководство)
